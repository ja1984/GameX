...
/**
 * Created by Jack on 2015-06-24.
 */
public class MyWebsocketTransport extends HttpClientTransport {
    ...
    public MyWebsocketTransport(Logger logger) {
        super(logger);
    }

    public MyWebsocketTransport(Logger logger, HttpConnection httpConnection) {
